...
namespace OutilEnquete.Models
{
    ...
    public class ApplicationDbContext : DbSet<ApplicationUser>
    {
        public DbSet<Questionnaire> Questionnaires { get; set; }
       // public DbSet<> Questions { get; set; }
       // public DbSet<WReponse> Reponses { get; set; }
        public DbSet<WReponse> Answers { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            modelBuilder.Entity<WReponse>()
                        .HasRequired(x => x.IdQuestion)
                        .WithMany()
                        .HasForeignKey(x => x.IdQuestionnaire)
                        .WillCascadeOnDelete(false);

            object p = base.OnModelCreating(modelBuilder);
        }
    }
}